...
layout = html.Div([
    ...
    dbc.Row([
        ...
        dbc.Col(dcc.Dropdown(id='country-dropdown', options=[{'label': attack, 'value': attack} for attack in df['Country'].unique()], value=['Afghanistan','Yemen','Iraq'], multi=True, placeholder="Select Country"), md=12)
        ], className="mt-3"),
